    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-primary to-blue-900 text-white">
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-white/10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate('/signup')} className="text-sm font-medium text-blue-200 hover:text-white border border-white/30 px-4 py-2 rounded-lg transition-all hover:bg-white/10">Sign Up</button>
        ...
        <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
          <div className="bg-primary rounded-xl p-4 mb-3 border border-white/10">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[['Attendance','94.2%','↑'],['Students','1,250','↑'],['Pending Fees','Rs.12,400','!'],['Notices','150','✓']].map(([k,v,s])=>(
